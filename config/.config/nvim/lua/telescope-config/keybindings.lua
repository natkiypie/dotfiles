...
keys.bind_normal_mode({
  ...
  {'<C-e>', '<CMD>lua require "telescope".extensions.file_browser.file_browser( require("telescope.themes").get_dropdown { layout_config = { width = 0.5, height = 0.5, }, prompt_title = "", results_title = "", previewer = false, borderchars = { prompt = {"─", "│", " ", "│", "┌", "┐", "│", "│"}, results = {"─", "│", "─", "│", "├", "┤", "┘", "└"}, preview = { "─", "│", "─", "│", "┌", "┐", "┘", "└"}, }, } )<CR>'},
})
