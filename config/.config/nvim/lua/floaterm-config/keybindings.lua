...
keys.bind_normal_mode {
  ...
  {'<C-a>', '<CMD>lua require"floaterm-config.utils".toggle{name="LazyGit", cmd="lazygit"}<CR>'},
  {'<C-c>', '<CMD>lua require"floaterm-config.utils".toggle{name="Glow", cmd="glow_script.sh"}<CR>'},
  {'<F8>', '<CMD>lua require"floaterm-config.utils".toggle{wintype="split", height="0.5", name="htop", cmd="htop -p `pidof vim`"}<CR>'},
...
keys.bind_terminal_mode {
  {'<C-t>', '<CMD>lua require"floaterm-config.utils".toggle{name="Terminal"}<CR>'},
  {'<C-a>', '<CMD>lua require"floaterm-config.utils".toggle{name="LazyGit"}<CR>'},
