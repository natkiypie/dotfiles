...
local split_winsize = utils.toggle('--height=1.0', '--height=0.5')

local vsplit_winsize = utils.toggle('--width=1.0', '--width=0.4')

local float_winsize = utils.toggle('--width=1.0 --height=1.0', '--width=0.6 --height=0.6')
